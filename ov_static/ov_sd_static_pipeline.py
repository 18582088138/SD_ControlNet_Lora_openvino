...
class OVStableDiffusionContrlNetPipeline(DiffusionPipeline):
    ...
    def preprocess_padding(self, image: Image.Image, batch_size, num_images_per_prompt):
        """
    ...
    def decode_latents_pad(self, latents:np.array, pad:Tuple[int]):
        """
    ...
    def __call__(
        ...
        image, pad = self.preprocess_padding(image, batch_size * num_images_per_prompt, num_images_per_prompt)
        ...
        # 8. Post-processing
        image = self.decode_latents_pad(latents, pad)
