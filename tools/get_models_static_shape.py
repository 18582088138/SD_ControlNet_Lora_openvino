...
if not UNET_OV_PATH.exists():
    if not UNET_ONNX_PATH.exists():
        ...
        del unet
    del pipe.unet
    ov_unet = convert_model(UNET_ONNX_PATH, compress_to_fp16=False)
...
if not TEXT_ENCODER_OV_PATH.exists():
    ...
    ov_txten = convert_model(TEXT_ENCODER_ONNX_PATH, compress_to_fp16=False)
...
if not VAE_DECODER_OV_PATH.exists():
    ...
    ov_vae = convert_model(VAE_DECODER_ONNX_PATH, compress_to_fp16=False)
